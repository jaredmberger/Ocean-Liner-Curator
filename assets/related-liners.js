...
(() => {
  ...
  const CLUSTERS = {
    ...
    pando_c_class_1925: cluster(
      "C-Class Sister Ships.",
      "Cathay, Comorin, and Chitral formed P&O’s three-ship mid-1920s C-class group for the Australia trade, combining passenger accommodation, refrigerated cargo capacity, and long-range Suez-route service.",
      [
        { href: "/ships/ss-cathay-1924", label: "SS <em>Cathay</em>", tail: "P&amp;O · 1925" },
    ...
    orient_postwar: cluster(
      ...
      [
        { href: "/ships/rms-orcades-1948", label: "RMS <em>Orcades</em>", tail: "Orient Line · 1948" },
        { href: "/ships/rms-oronsay", label: "RMS <em>Oronsay</em>", tail: "Orient Line · 1951" },
  ...
  const MAP = {
    ...
    "rms-orcades-1948": ["orient_postwar"],
    "rms-oronsay": ["orient_postwar"],
